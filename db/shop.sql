...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 23 2022 г., 20:41
...
CREATE TABLE `orders` (
  ...
  `session_basket` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
(1, '01.jpg', 'Худи', 'Кофта с капюшоном ', 1000),
(2, '02.jpg', 'Сумка', 'Сумка черного цвета', 1000),
(3, '03.jpg', 'Кроссовки', 'Спортивная обувь', 1000);
